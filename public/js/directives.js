    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            scope.showCountry = function(d) {
                ...
                var country = svg.selectAll(".country").data(d);
                country.attr("class", "active");
            }
            ...
            scope.clearClients = function(client) {
                delete scope.io.c;
                scope.io.c = {};
            }
...
//                        console.log(e);
                ...
                function select(d) {
                    ...
                    var c = isSelected(d);
                    if(c && c != scope.client) {
                        delete scope.io.c[c].selection[d.name];
                    }
                ...
                country.on("mousedown", function(d,i,v,f) {
