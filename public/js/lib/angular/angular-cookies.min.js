...
(function (m, f, l) {
    ...
    f.module("ngCookies", ["ng"]).factory("$cookies", ["$rootScope", "$browser", function (d, c) {
            ...
            d.$watch(function () {
                ...
                for (a in b)e = b[a], f.isString(e) ? e !== g[a] && (c.cookies(a, e), d = !0) : f.isDefined(g[a]) ? b[a] = g[a] : delete b[a];
                if (d)for (a in e = c.cookies(), b)b[a] !== e[a] && (k(e[a]) ? delete b[a] : b[a] = e[a])
            });
            return b
        }]).factory("$cookieStore",
            ["$cookies", function (d) {
